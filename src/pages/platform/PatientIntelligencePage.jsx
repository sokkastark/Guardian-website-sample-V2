...
export default function PatientIntelligencePage() {
  ...
  return (
    <ChildPageLayout
      ...
      eyebrow="PATIENT 360° & PATIENT MASTER CHART"
      headline="Unified clinical foundation with Patient 360° and Patient Master Chart."
      supporting="Guardian brings healthcare information together through two distinct layers: the comprehensive longitudinal repository of the Patient Master Chart (PMC) and the real-time, multidimensional clinical intelligence of Patient 360°."
      ctaText="Explore Patient Intelligence"
      journey={journey}
      journeyTitle="Patient Intelligence: Longitudinal Care Journey"
      journeySubtitle="How Guardian unifies healthcare data into the Patient Master Chart and delivers actionable Patient 360 views"
      capabilities={capabilities}
      capabilitiesTitle="Key Capabilities"
      capabilitiesSubtitle="What the Guardian Platform delivers for longitudinal patient intelligence"
      heroVisualBadge="PMC Repository + Patient 360 Layer"
      heroImage="/images/product-ui/ui-patient-360.png"
      mockupUrl="patient-360"
